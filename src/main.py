import cv2
path=r"C:\Users\neha0\OneDrive\Desktop\builder cv\task1\tom.webp"
image=cv2.imread(path)
imginvert=255-image

imagegray=cv2.cvtColor(image,cv2.COLOR_BGR2GRAY)
invertgray=255-imagegray
gaussianblur=cv2.GaussianBlur(invertgray,(81,81),0)
...
outputpath = r"C:\Users\neha0\OneDrive\Desktop\builder cv\task1\Build-Club-Recruitment\results\sketchoutput.png"
